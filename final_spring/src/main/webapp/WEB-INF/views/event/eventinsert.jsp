...
<body>
	...
	<div class="container">
			...
			<section id="container">
				...
				<form action="event_insertres.do" method="post">
				<div class="form-group">
					<label for="title" class="col-sm-2 control-label">제목</label>
					<input type="text" id="title" name="event_title" class="form-control"/>
				</div>
				<div class="form-group">
					<label for="content" class="col-sm-2 control-label">내용</label>
					<textarea id="content"  rows="10" name="event_content" class="form-control"></textarea>
				</div>
				<div class="form-group">
