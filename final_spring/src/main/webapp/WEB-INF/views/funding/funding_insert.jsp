...
<body>
	<div>
		<form method="post" enctype="multipart/form-data" action="funding_insertres.do">
			<div>
						펀딩 메인 사진
				<div><img id="preview"/>이미지 미리보기</div>
			...
			<div>
				<input type="text" required="required" name="funding_title" placeholder="펀딩 이름을 입력해 주세요."/>
			</div>
			<div>
				펀딩 카테고리
			...
			<div>
				펀딩 시작
				<input type="date" name="funding_start" required="required"/>
				펀딩 종료
				<input type="date" name="funding_end" required="required"/>
			</div>
			<div>
				목표 모금액
