            ...
            <div class="address_wrap">
               ...
               <div class="address_input_2_wrap">
                  <div class="address_input_2_box">
                     <input class="address_input_2" name="member_addr"
                        readonly="readonly">
                  </div>
               </div>
               <div class="address_input_3_wrap">
                  <div class="address_input_3_box">
                     <input class="address_input_3" name="member_addr"
                        readonly="readonly">
                  </div>
               </div>
...
$(document).ready(function(){
   ...
   $(".join_button").click(function(){
      ...
      /* 이메일 인증번호유효성 검사 */
      if(mail == ""){
         $('.mail_check_input').css('display','block');
         mailnumCheck = false;
      }else{
         $('.mail_check_input').css('display', 'none');
         mailnumCheck = true;
      }
...
$(".mail_check_button").click(function(){
   ...
   $.ajax({
      ...
      type:"GET",
      url:"login_mailCheck.do?email=" + email,
