...
INSERT INTO MEMBER
VALUES(MEMBERSEQ.NEXTVAL,'김태희','taehee','1234','taeheeworld@naver.com','010-6321-3789','서대문구','',1,0);
--
...
CREATE TABLE FUNDING(
	...
	FUNDING_FILTER VARCHAR2(30) NOT NULL,
	FUNDING_START VARCHAR2(50) NOT NULL,
	FUNDING_END VARCHAR2(50) NOT NULL,
	FUNDING_TA NUMBER NOT NULL,
	FUNDING_CA NUMBER NOT NULL,
	FUNDING_PAY NUMBER NOT NULL,
	FUNDING_STATUS VARCHAR2(30) NOT NULL CHECK(FUNDING_STATUS IN('진행중', '완료')),
	MEMBER_NO NUMBER NOT NULL,
	CONSTRAINT FUNDING_FK FOREIGN KEY(MEMBER_NO) REFERENCES MEMBER(MEMBER_NO) ON DELETE CASCADE
);
...
CREATE TABLE MESSAGE(
	...
	MESSAGE_RECV VARCHAR2(20) NOT NULL,
	MESSAGE_SENTDATE DATE NOT NULL,
	MESSAGE_READDATE DATE NOT NULL,
	MESSAGE_SENTDEL VARCHAR2(20) NOT NULL CHECK(MESSAGE_SENTDEL IN(0,1)), --미삭제 : 0 , 삭제 : 1
	MESSAGE_RECVDEL VARCHAR2(20) NOT NULL CHECK(MESSAGE_RECVDEL IN(0,1)),
